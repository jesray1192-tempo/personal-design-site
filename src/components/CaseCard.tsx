  ...
  return (
    <article className="border-t border-rule py-8 first:border-t-0 first:pt-0">
      <Link
        ...
        className="group grid gap-5 no-underline sm:grid-cols-[5rem_minmax(0,1fr)_auto] sm:items-start"
      >
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          {study.cover && study.coverSize ? (
            <Image
              ...
              className={`h-auto w-[4.5rem] shrink-0 border border-rule ${
                featured ? "sm:w-[5.5rem]" : ""
              }`}
              sizes="88px"
            />
          ) : null}
